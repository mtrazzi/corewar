...
int     do_one_cycle(t_env *e)
{
    ...
    while (elt)
    {
        // printf("{yellow}%d {green}%p %d{eoc} ", e->cyc_since_beg, ((t_prc *)elt->content), ((t_prc *)elt->content)->pc);
...
int     do_one_cycle(t_env *e)
{
    ...
    while (elt)
    {
        // printf("{yellow}%d {cyan}%p %d{eoc} ", e->cyc_since_beg, ((t_prc *)elt->content), ((t_prc *)elt->content)->pc);
