...
../resources/corewar -v 31 ../resources/champions_staff/$1.cor ../resources/champions_staff/$1.cor > zaz.log
echo "executing my corewar > my.log"
./corewar -v 31 ../resources/champions_staff/$1.cor ../resources/champions_staff/$1.cor > my.log
#echo "doing the diff"
