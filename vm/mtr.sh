...
../resources/corewar -v 31 ../resources/champions_staff/champ/$1.cor > log/zaz$1.log # ../resources/champions_staff/$1.cor > zaz.log
echo "executing my corewar > my$1.log"
./corewar -v 31 ../resources/champions_staff/champ/$1.cor > log/my$1.log #../resources/champions_staff/$1.cor > my.log
